...
\033[1;36m
 ...
 .M"""bgd `7MMF'  `7MMF'           `7MMM.     ,MMF'`7MMF'   `7MF'`7MMF'      
,MI    "Y   MM      MM               MMMb    dPMM    MM       M    MM        
`MMb.       MM      MM       ,AM     M YM   ,M MM    MM       M    MM        
  `YMMNq.   MMmmmmmmMM      AVMM     M  Mb  M' MM    MM       M    MM        
.     `MM   MM      MM    ,W' MM     M  YM.P'  MM    MM       M    MM      , 
Mb     dM   MM      MM  ,W'   MM     M  `YM'   MM    YM.     ,M    MM     ,M 
P"Ybmmd"  .JMML.  .JMML.AmmmmmMMmm .JML. `'  .JMML.   `bmmmmd"'  .JMMmmmmMMM 
                              MM                                             
                              MM
